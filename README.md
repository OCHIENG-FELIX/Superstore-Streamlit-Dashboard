...
Added dynamic KPIs and download functionality for business users
Deployed live on Streamlit Cloud

Link: Superstore BI Dashboard(https://superstore-app-dashboard-8z3bvexj9vfh34c4ezeqon.streamlit.app/)
Technologies: Python, Pandas, Plotly, Streamlit
This project demonstrates end-to-end data application development, business insight generation, and deployment skills.
